    ...
    <div class="promotions">
        ...
        <div class="promotions-item">
            <div class="table-responsive">
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        <tr>
                            <td class="align-middle">07:30 - 09:30</td>
                            <td>
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                <h3>party Ice cream upto 50% off</h3>
                <ul>
                    <li>
                        <p>Order more than 20 scoop will get discount 50%</p>
                    </li>
                    <li>
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                <h3>Happy Snack upto 25% extra</h3>
                <ul>
                    <li>
                        <p>Free lassi</p>
                    </li>
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                <h3>New Dessert upto 100% Cashback</h3>
                <ul>
                    <li>
                        <p>Free 01 Rabdi when total bill more than Rs.599</p>
                    </li>
                    <li>
                        <p>From 12/04/2024 to 12/05/2024</p>
                    </li>
                    <li>
                        <p>Only Home Delivery</p>
                    </li>
                </ul>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
