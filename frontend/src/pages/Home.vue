    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <p>Step into a world of sweetness and delight! Welcome to New Calcutta Sweets, where every treat is a little piece of happiness.</p>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
            <div class="image">
                <img src="../assets/images/b.png" alt="" class="home-img">
                <!-- <img src="../assets/images/a.jpg" alt="" class="home-parallax-img"> -->
            </div>
        </div>
        ...
        <div class="home-category">
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/taco/taco-1.png" alt="">
                <h3>Sweet</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/burrito/burrito-1.png" alt="">
                <h3>South In.</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/nachos/salsa-1.png" alt="">
                <h3>Snacks</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/side/side-1.png" alt="">
                <h3>Dessert</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/dessert/dessert-1.png" alt="">
                <h3>Hot Drink</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/drink/drink-3.png" alt="">
                <h3>Ice cream</h3>
            </router-link>
        </div>
        ...
        <div class="home-banner">
            <div class="grid-banner row">
                <div class="grid col-md-4">
                    <img src="../assets/images/ice.jpg" alt="">
                    <div class="content">
                        <span style="color: black;">special offer</span>
                        <h3 style="color: black;">upto 50% off</h3>
                        <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
                    </div>
                </div>
                ...
                <div class="grid col-md-4">
                    <img src="../assets/images/side/side-1.png" alt="">
                    <div class="content">
                        <span style="color: black;">limited offer</span>
                        <h3 style="color: black;">upto 100% cashback</h3>
                        <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
                    </div>
                </div>
        ...
        <div class="home-about">
            <div class="image">
                <img src="../assets/images/sweetdecor.jpg" alt="">
            </div>
            <div class="content">
                <span>why choose us?</span>
                <h3 class="title">what's make our food delicious!</h3>
                <p>Food to customers is always guaranteed of the best quality. Our dishes are made by Chef Dinesh Yadav, promising to bring explosive, delicate, impressive flavors. Our delivery
