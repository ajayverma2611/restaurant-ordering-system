        ...
        <div class="row">
            <div class="col-sm-4 col-12 filter-box">
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            <input type="button" name="rPrice" id="rtfPrice" value="20.00,50.00" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rtfPrice" class="d-flex justify-content-between">Rs.20 - Rs.50 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>

                        <li>
                            <input type="button" name="rPrice" id="rftPrice" value="50.00,100.00" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rftPrice" class="d-flex justify-content-between">Rs.50 - Rs.100 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>

                        <li>
                            <input type="button" name="rPrice" id="rttPrice" value="300.00,399.00" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rttPrice" class="d-flex justify-content-between">Rs.300 - Rs.400 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>

                        <li>
                            <input type="button" name="rPrice" id="mtPrice" value="400.00" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="mtPrice" class="d-flex justify-content-between">{{ ">" }} Rs.400 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>

                        <li>
                            <input type="button" name="rPrice" id="ltPrice" value="398.00" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="ltPrice" class="d-flex justify-content-between">{{ "<" }} Rs.400 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            <input type="button" name="rType" id="mType" value="sugar" hidden
                                @click="filterTypeBtn($event)" />
                            <label for="mType" class="d-flex justify-content-between">Sugar<button class="unselect-btn"
                                    @click="unselectTypeBtn($event)">X</button></label>
                        </li>

                        <li>
                            <input type="button" name="rType" id="vType" value="sugar Free" hidden
                                @click="filterTypeBtn($event)" />
                            <label for="vType" class="d-flex justify-content-between">Sugar Free<button class="unselect-btn"
                                    @click="unselectTypeBtn($event)">X</button></label>
                        </li>
                ...
                <div class="row">
                    <div class="menu-tabs">
                        ...
                        <input type="button" id="drinkFilterFoodBtn" name="drinkFilterFoodBtn" class="menu-tab-item"
                            value="Ice Cream" @click="filterFoodBtn($event)" />
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        evaluatePrice: function (food, priceRange) {
            ...
            if (priceRange == "20.00,50.00") {
                if (20.00 <= cal && cal <= 50.00) {
                    return food;
                }
            }
            else if (priceRange == "50.00,100.00") {
                if (50.00<= cal && cal <= 100.00) {
                    return food;
                }
            }
            else if (priceRange == "300.00,399.00") {///////////////////////////////////////////////
                if (300.00<= cal && cal <= 399.00) {
                    return food;
                }
            }
            else if (priceRange == "400.00") {
                if (cal <= 400.00) {
                    return food;
                }
            }
            else if (priceRange == "398.00") { ///////////////////////////////
                if (cal >= 398.00) {
                    return food;
                }
            }
