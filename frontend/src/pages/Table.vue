    ...
    <section class="order-section">
        ...
        <div class="icons-container">
            ...
            <div class="icons ">
                ...
                <h3>7:30am to 10:30pm</h3>
            </div>

            <div class="icons">
                <img src="../assets/images/icon-2.png" alt="">
                <h3>+91 788-2344256</h3>
            </div>

            <div class="icons">
                <img src="../assets/images/icon-3.png" alt="">
                <h3>New Calcutta Sweets, Borsi Durg Chhattisgarh -491001</h3>
            </div>
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="input-box">
                    <iframe class="map" 
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7441.279423640699!2d81.2967854!3d21.1667318!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a293c863000449b%3A0x49700e310a1a17e0!2sNew%20Calcutta%20Sweets!5e0!3m2!1sen!2sin!4v1712824069738!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div> 
            </div>
